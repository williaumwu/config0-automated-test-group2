...
#
# Automated-test stack fixture (group2). Pulls in the group1 run_terraform
# execgroup and the group0 resource_wrapper.sh script via williaumwu FQNs.
# No selectors, no credentials — it only needs to exercise the scan passes.
"""
